...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.title2": "sunrise",
    "hero.tagline": "Service is Culture, Service is True Dharma",
    "hero.desc":
  ...
  gu: {
    ...
    "hero.tagline": "સેવા એ જ સંસ્કાર, સેવા એ જ સાચો ધર્મ",
    "hero.desc":
    ...
    "contact.form.subject": "વિષય",
    "contact.form.message": "સંદેશો",
  ...
  hi: {
    ...
    "hero.tagline": "सेवा ही संस्कार, सेवा ही सच्चा धर्म",
    "hero.desc":
    ...
    "contact.form.phone": "फ़ोन (वैकल्पिक)",
