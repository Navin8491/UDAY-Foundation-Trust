...
export const PROGRAMS_DETAIL_DATA = [
  {
    ...
    color: "#4040A1",
    image: imgEdu,
    thumbnails: [imgEdu, imgEdu2, imgEdu3],
    title: {
    ...
    activities: [
      ...
      },
      {
        ...
        hi: "अनाथ और जरूरतमंद बच्चों की फीस and पढ़ाई के खर्च में सहायता करना।",
      },
      {
  ...
  },
  {
    ...
    color: "#7A9D1C",
    image: imgHealth,
    thumbnails: [imgHealth, imgHealth2, imgHealth3],
    title: {
    ...
    successStory: {
      ...
      gu: "૬૫ વર્ષીય વિધવા લક્ષ્મીબેનને મોતિયાના કારણે આંખે દેખાતું બંધ થયું હતું અને પ્રાઈવેટ ઓપરેશન કરાવવા પૈસા ન હતા. સોયલાના તબીબી કેમ્પમાં તપાસ બાદ સંસ્થાએ તેમનું મફત ઓપરેશન કરાવી આપ્યું, and આજે તેઓ જોઈ શકે છે.",
  ...
  },
  {
    ...
    iconName: "Baby",
    color: "#E29A5C",
    image: childWelfareDirect,
    thumbnails: [childWelfareDirect, welfare2, welfare3],
    title: {
      en: "Child Welfare",
      gu: "બાળ કલ્યાણ",
      hi: "बाल कल्याण",
  ...
  },
  {
    ...
    iconName: "HomeIcon",
    color: "#E2C35C",
    image: ruralDevCommunity,
    thumbnails: [ruralDevCommunity, ruralOutreachDirect, hebatpur8],
    title: {
  ...
  },
  {
    ...
    color: "#7A9D1C",
    image: imgTrees,
    thumbnails: [imgTrees, imgTrees2, imgTrees3],
    title: {
  ...
  },
  {
    ...
    color: "#E25C5C",
    image: imgTauktae1,
    thumbnails: [imgTauktae1, imgTauktae2, imgCovid1],
    title: {
      en: "Disaster Relief",
      gu: "આફત રાહત",
      hi: "આપદા રાહત",
  ...
  },
  {
    ...
    color: "#4040A1",
    image: imgHuman1,
    thumbnails: [imgHuman1, imgHuman2, imgHuman3],
    title: {
      en: "Humanitarian Aid",
      gu: "માનવતાવાદી સહાય",
      hi: "માનવીય સહાય",
    ...
    activities: [
      {
        ...
        gu: "ノードされたજરૂરિયાતમંદ વિધવા બહેનોને દર મહિને ઘર બેઠા રાશન કીટ પહોંચાડવી.",
    ...
    impactVal: {
      ...
      hi: "૧૨,૦૦૦+ परिवारों को राशन किट वितरण",
    },
    successTitle: {
    ...
    successQuote: {
      ...
      hi: '"ईसाई ट्रस्ट मेरे बच्चों की तरह हर महीने मेरे घर राशन पहुंचाता है।" — रंभाबेन',
    },
  },
  {
    id: "empowerment",
    ...
    color: "#E25C96",
    image: welfare3,
    thumbnails: [welfare3, welfare2, childWelfareDirect],
    title: {
    ...
    desc: {
      en: "Tailoring and sewing workshops, financial literacy camps, and micro-entrepreneurship programs for rural women.",
      gu: "ગ્રામીણ મહિલાઓ પગભર બને તે માટે સિલાઈ મશીન તાલીમ વર્ગો, આર્થિક સાક્ષરતા કેમ્પ અને ગૃહ ઉદ્યોગ માર્ગદર્શન.",
      hi: "ग्रामीण महिलाओं के आत्मनिर्भरता के लिए सिलाई मशीन प्रशिक्षण, वित्तीय साक्षरता और कुटीर उद्योग प्रशिक्षण।",
    },
    objectives: [
      {
        en: "Promote financial independence through skill building.",
        gu: "કૌશલ્ય તાલીમ આપી ગ્રામીણ બહેનોને આર્થિક રીતે સ્વનિર્ભર કરવી.",
        hi: "कौशल प्रशिक्षण देकर ग्रामीण महिलाओं को आत्मनिर्भर बनाना।",
      },
      {
        en: "Provide tools and equipment like sewing machines to trained women.",
        gu: "તાલીમ મેળવેલ બહેનોને સિલાઈ મશીન અને અન્ય સાધનોની સહાય આપવી.",
        hi: "प्रशिक्षित महिलाओं को सिलाई मशीन और अन्य आवश्यक उपकरण प्रदान करना।",
      },
      {
        en: "Conduct health and hygiene campaigns focusing on rural mothers.",
        gu: "માતૃત્વ સ્વાસ્થ્ય અને કલ્યાણ માટે મહિલાઓ માટે વિશેષ શિબિરો યોજવી.",
        hi: "मातृत्व स्वास्थ्य और कल्याण के लिए महिलाओं के लिए विशेष शिविर आयोजित करना।",
      },
    ],
    activities: [
      {
        en: "Running free 3-month tailoring and fashion design courses in villages.",
        gu: "ગામડાઓમાં બહેનો માટે ૩ મહિનાના ફ્રી સિલાઈ તાલીમ વર્ગો ચલાવવા.",
        hi: "गाँवों में महिलाओं के लिए ३ महीने के मुफ्त सिलाई प्रशिक्षण शिविर चलाना।",
      },
      {
        en: "Facilitating self-help group formation and banking connections.",
        gu: "બહેનોના સખી મંડળ બનાવી બેંક લોન અને બચત ખાતા ખોલાવવામાં સહાય.",
        hi: "महिला स्वयं सहायता समूहों का गठन और बैंक ऋण प्राप्त करने में मदद।",
      },
      {
        en: "Providing free sewing machines to top graduates to start home businesses.",
        gu: "તાલીમ પૂરી કરનાર તેજસ્વી બહેનોને મફત સિલાઈ મશીનનું વિતરણ કરવું.",
        hi: "प्रशिक्षण पूरा करने वाली मेधावी महिलाओं को मुफ्त सिलाई मशीन वितरित करना।",
      },
    ],
    impactVal: {
      en: "350+ Women Trained",
      gu: "૩૫૦+ બહેનોને તાલીમ સહાય",
      hi: "३५०+ महिलाओं को प्रशिक्षण सहायता",
    },
    successTitle: {
      en: "Savita's Tailoring Shop",
      gu: "સવિતાબેનની સિલાઈ દુકાન",
      hi: "सविताबेन की सिलाई दुकान",
    },
    successStory: {
      en: "Savita from Sanand had no source of income after her husband's illness. She joined Uday Foundation's free tailoring school. After finishing the course, she received a free sewing machine and now runs a successful tailoring business from home, earning a livelihood.",
      gu: "પતિની બીમારી બાદ સાણંદના સવિતાબેન માટે ઘર ચલાવવું મુશ્કેલ હતું. તેઓએ ઉદય ફાઉન્ડેશનના ફ્રી સિલાઈ ક્લાસમાં ભાગ લીધો. તાલીમ બાદ સંસ્થાએ આપેલ સિલાઈ મશીનથી આજે તેઓ ઘરે દરજીકામ કરી સારો પગાર મેળવે છે.",
      hi: "पति की बीमारी के बाद सानंद की सविताबेन के लिए घर चलाना मुश्किल था। उन्होंने उदय फाउंडेशन की मुफ्त सिलाई कक्षा में प्रवेश लिया। प्रशिक्षण के बाद मिली सिलाई मशीन से आज वे आत्मनिर्भर हैं।",
    },
    successQuote: {
      en: '"Now I can support my children\'s education with my own earnings." — Savita',
      gu: '"હવે હું મારી પોતાની કમાણીથી મારા બાળકોના શિક્ષણનો kharch ઉઠાવી શકું છું." — સવિતાબેન',
      hi: '"अब मैं अपनी कमाई से अपने बच्चों की शिक्षा का खर्च उठा सकती हूँ।" — सविताबेन',
    },
  },
];
