...
import heroChildren_raw from "@/assets/hero-children.jpg";
const heroChildren = (heroChildren_raw as any).src || heroChildren_raw;
import imgHealth_raw from "@/assets/program-health.jpg";
const imgHealth = (imgHealth_raw as any).src || imgHealth_raw;
import imgEdu_raw from "@/assets/program-education.jpg";
const imgEdu = (imgEdu_raw as any).src || imgEdu_raw;
import imgTrees_raw from "@/assets/program-trees.jpg";
const imgTrees = (imgTrees_raw as any).src || imgTrees_raw;
import imgRation_raw from "@/assets/activity-ration.jpg";
const imgRation = (imgRation_raw as any).src || imgRation_raw;
import president_raw from "@/assets/president.jpg";
const president = (president_raw as any).src || president_raw;
        ...
        <div className="container-page relative pt-10 md:pt-16 pb-20 md:pb-28 grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-6 order-2 lg:order-1">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/donate" className="btn-saffron text-base">
      ...
      <section className="section-y bg-surface">
        <div className="container-page">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
            ...
            <Link href="/events" className="btn-ghost text-sm self-start md:self-end">
        ...
        <div className="container-page grid lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-5">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link href="/transparency" className="btn-primary text-sm">
        ...
        <div className="relative overflow-hidden rounded-[2rem] bg-primary text-primary-foreground p-10 md:p-16">
          ...
          <div className="relative grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-wrap gap-3 md:justify-end">
              <Link href="/donate" className="btn-saffron">
